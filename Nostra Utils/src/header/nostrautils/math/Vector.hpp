...
namespace NOU::NOU_MATH
{
	...
	{
		return Vector<T, 2>(value(0) * scale, value(1) * scale);
	}
	...
	{
		return Vector<T, 2>(value(0), value(1));
	}
	...
	{
		return Vector<T, 3>(value(0) * scale, value(1) * scale, value(2) * scale);
	}
	...
	{
		return Vector<T, 3>(
				value(1) * other.value(2) - value(2) * other.value(1),
				value(2) * other.value(0) - value(0) * other.value(2),
				value(0) * other.value(1) - value(1) * other.value(0));
	}
	...
	{
		return Vector<T, 3>(value(0), value(1), value(2));
	}
	...
	{
		return Vector<T, 4>(value(0) * scale, value(1) * scale, value(2) * scale, value(3) * scale);
	}
	...
	{
		return Vector<T, 4>(value(0), value(1), value(2), value(3));
	}
