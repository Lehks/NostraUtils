...
\details
A file that provides the entire thread system. It does not provide any additional functionality, but includes 
the components of the thread system in a compiling order.
*/
